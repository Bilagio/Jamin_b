...
VALUES
    ...
    ('mango mango mango', '1', 1, NULL, SYSDATE(6), SYSDATE(6)),
    ...
    ('Winter Arc', '500', 1, NULL, SYSDATE(6), SYSDATE(6)),
    ...
    ('Bister Meast 𝓕𝓻𝓮𝓪𝓴𝔂 Feastables 👅👅', '8719587427527', 1, NULL, SYSDATE(6), SYSDATE(6)),
    ('Stillwater', '8719599327527', 1, NULL, SYSDATE(6), SYSDATE(6)),
...
VALUES
    ...
    (5, 3, 0, 1, NULL, SYSDATE(6), SYSDATE(6)),
    (6, 2, 0, 1, NULL, SYSDATE(6), SYSDATE(6)),
